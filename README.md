...
![Exadel Authoring Kit Logo](https://github.com/exadel-inc/etoolbox-authoring-kit/blob/develop-2.0.2/all/src/main/content/META-INF/vault/definition/thumbnail.png)

Exadel Authoring Kit for AEM (part of Exadel Toolbox), or simply the **ToolKit**, is a set of tools for creating robust Granite / Touch UI dialogs and plenty of other authoring interfaces for Adobe Experience Manager&trade; with Java and Maven.
