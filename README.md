...
Exadel Toolbox Authoring Kit, or simply the **ToolKit**, is a set of tools for creating robust Granite / Touch UI dialogs and plenty of other authoring interfaces for Adobe Experience Manager&trade; with Java and Maven.
...
The ToolKit has many options to make authoring interfaces rich, flexible and responsive with minimal effort. No deep knowledge of Granite&trade;, Coral&trade; and AEM clientlibs needed. A scope of fine interactivity features is ready out of the box with zero to small manual setup.
