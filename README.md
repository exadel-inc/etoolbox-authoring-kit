...
Exadel Toolbox Authoring Kit, or simply the **ToolKit**, is a set of tools for creating robust Granite/Touch UI dialogs and other authoring interfaces for Adobe Experience Manager&trade; with Java and Maven.
...
The ToolKit is developed in the course of Exadel&trade; Digital Marketing Technology Practice (MarTech) as part of the **Exadel Toolbox** initiative.
