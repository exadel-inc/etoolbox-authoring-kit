...
<em>Note:</em> As of Exadel Authoring Kit 2.8.0, <em>Configurator</em> is an experimental feature. You need to specially enable it through your own AEM project by adding a configuration file like the following:
