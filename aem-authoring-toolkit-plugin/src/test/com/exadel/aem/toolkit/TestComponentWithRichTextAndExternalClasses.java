...
@Dialog(
        ...
        tabs = {
                @Tab(title = "Main tab"),
                @Tab(title = TestComponentWithRichTextAndExternalClasses.TAB_LINKS),
                @Tab(title = TestComponentWithRichTextAndExternalClasses.TAB_FEATURED_CARD_1),
                @Tab(title = TestComponentWithRichTextAndExternalClasses.TAB_FEATURED_CARD_2),
        },
...
@EditConfig(
        dropTargets = {
                @DropTargetConfig(
                        ...
                        accept = {"image/.*"},
                        groups = {"media"},
                        propertyName = TestComponentWithRichTextAndExternalClasses.PREFIX_FIRST + "Image1" + "reference1"
                ),
                @DropTargetConfig(
                        nodeName = "featuredimage2",
                        accept = {"image/.*"},
                        groups = {"media"},
                        propertyName = TestComponentWithRichTextAndExternalClasses.PREFIX_SECOND + "Image2" + "reference2"
                )
        },
        inplaceEditing = {
                ...
                @InplaceEditingConfig(
                        ...
                        richText = @Extends(value = TestComponentWithRichTextAndExternalClasses.class, field = "description")
                )
        }
)
public class TestComponentWithRichTextAndExternalClasses {
    ...
    static final String PREFIX_FIRST = "first_";
    ...
    @MultiField(field = com.exadel.aem.toolkit.SecondExternalClass.class)
    @PlaceOnTab(TAB_LINKS)
