...
public class ResourceTypes {
    ...
    public static final String AUTOCOMPLETE_CORAL_3 = "etoolbox-authoring-kit/components/authoring/autocomplete";
    ...
    public static final String DATEPICKER = "granite/ui/components/coral/foundation/form/datepicker";
    public static final String DIALOG = "cq/gui/components/authoring/dialog";
