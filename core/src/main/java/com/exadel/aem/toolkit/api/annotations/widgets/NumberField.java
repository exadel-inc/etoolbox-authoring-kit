 ...
 * NumberField element</a> in Granite UI
 */
...
public @interface NumberField {
    ...
    /**
     * Maps to the 'min' attribute of this Granite UI component's node.
     * Used to define minimal number that may be stored in a NumberField
     * @return Double value
     */
    double min() default -Double.MAX_VALUE;
    /**
     * Maps to the 'max' attribute of this Granite UI component's node.
     * Used to define maximal number that may be stored in a NumberField
     * @return Double value
     */
    double max() default Double.MAX_VALUE;
    /**
     * Maps to the 'step' attribute of this Granite UI component's node.
