...
public @interface AllowedChildren {
     ...
     * <p>You can use wildcards, e.g. {@code "acme/pages/design2/*", "*design2/homepage",
     * "*pages/design2/*"}.
     * <p><u>Note</u></p>: every item can represent either a single parent or a "chain" -- a succession of
     ...
     * with resource type matching "acme/pages/design2/*", and below it there must be another component with resource type matching "*design2/homepage".
     * They need not be direct parent and child: any level of nesting is allowed. This works much like a sequence of CSS selectors.
     * <p><u>Note</u></p>: If you use sequences of parents within one entry and one of them is a group with a space in its name, you should escape it with single quotes.
