 ...
 * Password element</a> in Granite UI
 */
...
public @interface Password {
    ...
    /**
     * When set to a non-blank string, maps to the 'autocomplete' attribute of this Granite UI component's node.
    ...
    /**
     * When set to true, maps to the 'autofocus' attribute of this Granite UI component's node.
    ...
    /**
     * When set to a non-blank string, maps to the 'retype' attribute of this Granite UI component's node.
