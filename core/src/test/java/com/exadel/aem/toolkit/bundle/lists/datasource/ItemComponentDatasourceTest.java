...
public class ItemComponentDatasourceTest {
    ...
    @Before
    public void setUp() {
        context.load().json("/com/exadel/aem/toolkit/bundle/lists/datasource/genericItem.json", GENERIC_ITEM_PATH);
        context.load().json("/com/exadel/aem/toolkit/bundle/lists/datasource/simpleItem.json", SIMPLE_ITEM_PATH);
    }
