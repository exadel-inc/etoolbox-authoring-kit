...
public enum TestEnum {
    TEST_ENUM_VALUE_1("textMember1", "valueMember1", "attributeMember1"),
    TEST_ENUM_VALUE_2("textMember2", "valueMember2", "attributeMember2"),
    TEST_ENUM_VALUE_3("textMember3", "valueMember3", "attributeMember3");
