...
public class StringsMap extends RequestAdapterBase<Map<String, String>> {
    ...
    @Inject
    public StringsMap(@EToolboxList(EToolboxListInjectorTest.SIMPLE_LIST_PATH) @Named Map<String, String> constructorValue) {
    ...
    @Model(
        adaptables = {SlingHttpServletRequest.class, Resource.class},
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
    public interface Supplier extends ValueSupplier<Map<String, String>> {
        @EToolboxList(EToolboxListInjectorTest.SIMPLE_LIST_PATH)
        @Override
