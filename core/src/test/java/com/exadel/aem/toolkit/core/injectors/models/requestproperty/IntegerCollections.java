...
public class IntegerCollections extends RequestAdapterBase<Collection<Integer>> {
    ...
    @Inject
    public IntegerCollections(@RequestProperty @Named(CoreConstants.PN_VALUE) List<Integer> value) {
        super(value);
    }
