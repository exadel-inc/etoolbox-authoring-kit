...
public class StringCollections extends RequestAdapterBase<Collection<String>> {
    ...
    @Inject
    public StringCollections(@RequestProperty @Named(CoreConstants.PN_VALUE) List<String> value) {
        super(value);
    }
