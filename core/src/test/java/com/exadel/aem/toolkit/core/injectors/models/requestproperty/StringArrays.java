...
public class StringArrays extends RequestAdapterBase<String[]> {
    ...
    @Inject
    public StringArrays(@RequestProperty @Named(CoreConstants.PN_VALUE) String[] value) {
        super(value);
    }

    @Override
    public ValueSupplier<String[]> getValueSupplier() {
    ...
    @Model(adaptables = SlingHttpServletRequest.class, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
    public interface Supplier extends ValueSupplier<String[]> {
